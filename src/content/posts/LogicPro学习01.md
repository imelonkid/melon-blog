...
<img style="margin-left: 10px;box-shadow: 10px 10px 10px rgba(0,0,0,.5);" src="/posts/logicpro学习01/sys-version.jpg" width = "70%" height="60%" />
...
<table>
    <tr>
        <td><img src="/posts/logicpro学习01/sys-set-01.jpg" width = "100%" height="60%" /></td>
        <td><img src="/posts/logicpro学习01/sys-set-02.jpg" style="max-height: 100%;" width = "100%" height="100%" /></td>
    </tr>
</table>

从上面入口进入APP语言设置界面
<img style="margin-left: 10px;box-shadow: 5px 5px 5px rgba(0,0,0,.5);" src="/posts/logicpro学习01/sys-set-03.jpg" width = "70%" height="60%" />
...
<img style="margin-left: 10px;box-shadow: 5px 5px 5px rgba(0,0,0,.5);" src="/posts/logicpro学习01/logic-01.jpg" width = "80%" height="60%" />
...
<img style="margin-left: 10px;box-shadow: 5px 5px 5px rgba(0,0,0,.5);" src="/posts/logicpro学习01/logic-02.jpg" width = "80%" height="60%" />

接下来进入工作区
<img src="/posts/logicpro学习01/logic-04.jpg" width = "100%" height="60%" />
如上图所示：
...
<img src="/posts/logicpro学习01/logic-05.jpg" width = "100%" height="60%" />
